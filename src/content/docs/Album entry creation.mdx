...
If you're unsure if the album should be added in the first place, please read the [content policy for albums](/docs/guidelines/content-policy#albums).
...
These are **different** from the [finished album entry requirements](/docs/albums/album-entry-editing.html#finished-album-entry-requirements).
