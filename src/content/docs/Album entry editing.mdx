...
[Deleting album entries](https://wiki.vocadb.net/wiki/54/content-removal-guidelines) | [Merging album entries](https://wiki.vocadb.net/wiki/46/merging-entries)
...
More on the page [Album types and artist participation](https://wiki.vocadb.net/wiki/8/album-types-and-artist-participation).
...
The first [release event](https://wiki.vocadb.net/wiki/36/events) that the album was released in.
...
Same rules as with the songs: [wiki/89/song-entry-editing#Artist-roles](https://wiki.vocadb.net/wiki/89/song-entry-editing#Artist-roles)
...
Clicking a track by its name opens the "Track properties" -window, which can be used to add artists to the song (track) entry. Only the artists which are added in the ["Artists"-tab](https://wiki.vocadb.net/wiki/86/album-entry-editing#tab-Artists) are visible. 
...
* [Media (video) services supported by VocaDB](https://wiki.vocadb.net/wiki/31/media-video-services-supported-by-vocadb)
