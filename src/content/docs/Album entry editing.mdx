...
The edit page also includes buttons for [deleting](/docs/other-guidelines/content-removal-guidelines) and [merging](/docs/other-guidelines/merging-entries) album entries.

The edit page is split into 6 different tabs:

1) [Basic info](/docs/albums/album-entry-editing#tab-1-basic-info)
2) [Artists](/docs/albums/album-entry-editing#tab-2-artists)
3) [Discs](/docs/albums/album-entry-editing#tab-3-discs)
4) [Tracks](/docs/albums/album-entry-editing#tab-4-tracks)
5) [Additional pictures](/docs/albums/album-entry-editing#tab-5-additional-pictures)
6) [Media](/docs/albums/album-entry-editing#tab-6-media)
...
<RuleEmbed ruleId={55} fields={["id"]}/>
<RuleEmbed ruleId={56} fields={["id"]}/>
...
<RuleEmbed ruleId={64} fields={["id", "entry_status"]}/>

<RuleEmbed ruleId={166} fields={["id", "entry_status"]}/>
...
➡️ Next: [Song lists](/docs/secondary-entry-types/song-lists)