...
[Deleting album entries](/docs/guidelines/content-removal-guidelines) | [Merging album entries](/docs/guidelines/merging-entries)
...
The first [release event](/docs/guidelines/events) that the album was released in.
...
- [Media (video) services supported by VocaDB](/docs/documentation/media-video-services-supported-by-vocadb)
