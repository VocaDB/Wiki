...
[The album entry status](/docs/album-entry-editing#Status) is shown with at the end of this line.
...
Opens the [Edit page](/docs/album-entry-editing) for the album entry.
...
The version page has two user actions available (four for [Moderator+](/docs/user-groups)).
...
Creates an [Entry Report](/docs/entry-reports) and adds it to the [Entry Report list](https://vocadb.net/Admin/ViewEntryReports) visible to Trusted Users and up.
...
Custom format string usage is documented on the [Album track format strings for the custom CSV export](/docs/album-track-format-strings-for-the-custom-csv-export) page.
...
[Circle(s)](/docs/artist-entry-editing#Circle) associated with the album entry.

##### Label(s)

[Labels](/docs/artist-entry-editing#Label) associated with the album entry.

##### Other artists

All other artist types (for example, Illustrators, Lyricists, etc.) and roles.

#### [Description](/docs/album-entry-editing#Album-description)
...
[Album type](/docs/album-entry-editing#Record-type)
...
The entry tags are displayed as a table with the columns _Tag_, _Count_, _Votes_ (Visible to [Moderator+](/docs/user-groups) only), _Date_.

Tags can be removed by any trusted user, regardless of who added and voted for the tag.

#### Release date

[Release date](/docs/album-entry-editing#Release-date) of the album.

#### Catalog number

[Catalog number](/docs/album-entry-editing#Catalog-number) of the album.

#### Release event

[Release event(s)](/docs/album-entry-editing#Release-event) of the album.
...
List of the [languages in the tracklist](/docs/song-entry-editing#Languages).

#### Ads / crossfades

Album [ads and crossfades](/docs/album-entry-editing#tab-Media).
...
Entry creation date. Corresponds to the last row in [the entry history -table](/docs/album-entry-page#View-modifications), except for some very early entries.

#### Tracklist

[Tracklist](/docs/album-entry-editing#tab-Tracks) of the entry, separated by disc (if applicable).

If all of the tracks include a [duration](/docs/song-entry-editing#Duration), the total album duration/length is calculated and displayed.
...
Always follow the [discussion rules](/docs/discussion-rules). 
...
[Additional album pictures](/docs/album-entry-editing#tab-Additional-pictures) (such as an album's back cover art) are displayed on this tab.
