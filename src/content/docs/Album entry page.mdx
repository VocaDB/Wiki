...
_synthesis by Tripshots_ for example: https://vocadb.net/Al/1
...
Custom format string usage is documented on page [Album track format strings for the custom CSV export](/docs/albums/album-track-format-strings-for-the-custom-csv-export).
...
Album entry is a duplicate and should be [merged](/docs/other-guidelines/merging-entries). A link to the duplicate album entry is required along with proof.

#### 3. Inappropriate content

For album entries that [do not belong to VocaDB](/docs/other-guidelines/content-policy#Albums).
...
[Circles](/docs/artists/artist-entry-editing#Circle) of the album entry.

##### Label(s)

[Labels](/docs/artists/artist-entry-editing#Label) of the album entry.
...
If all of the tracks include [duration](/docs/songs/song-entry-editing#Duration), the total duration/length is calculated and displayed.
