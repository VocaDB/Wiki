...
The edit page also includes buttons for [deleting](/docs/other-guidelines/content-removal-guidelines) and [merging](/docs/other-guidelines/merging-entries) artist entries.

The edit page is split into 2 different tabs:

1) [Basic info](/docs/artists/artist-entry-editing#tab-1-basic-info)
2) [Additional pictures](/docs/artists/artist-entry-editing#tab-2-additional-pictures)
...
<RuleEmbed ruleId={84} fields={["id"]}/>
<RuleEmbed ruleId={165} fields={["id"]}/>
...
<RuleEmbed ruleId={86} fields={["id"]}/>

### Groups and circles

For grouping related artists under a shared group/circle.

<RuleEmbed ruleId={87} fields={["id"]}/>
<RuleEmbed ruleId={82} fields={["id"]}/>
<RuleEmbed ruleId={83} fields={["id"]}/>

### Base voicebank

<RuleEmbed ruleId={91} fields={["id"]}/>
