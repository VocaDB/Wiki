...
From [VocaDb.Model.Resources.json](https://github.com/VocaDB/vocadb/blob/60325c247287e2f0ca2e22a2604ac5a4c5e56898/VocaDbWeb/public/locales/quc/VocaDb.Model.Resources.json#L54):

- NeedReferences, corresponds to [Rule: Artist source required](/docs/pinned/rule-reference#rule-artist-source-required).
...
- UnnecessaryPName, corresponds to [Rule: No producer name duplication](/docs/pinned/rule-reference#rule-no-producer-name-duplication).
