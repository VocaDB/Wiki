...
[The artist entry status](/docs/artists/artist-entry-editing#Status) is shown with an icon on this line.
...
The "Edit" -button opens [the edit-page](/docs/artists/artist-entry-editing#Artist-entry-editing) for the artist entry.
...
Creates an [entry report](/docs/pinned/entry-reports) and adds it to the [entry report -list](https://vocadb.net/Admin/ViewEntryReports) that is visible to trusted users+
...
Artist entry is a duplicate and should be [merged](/docs/other-guidelines/merging-entries). A link to the duplicate artist entry is required along with proof.

#### 3. Inappropriate content

For artists entries that [do not belong to VocaDB](/docs/other-guidelines/content-policy#Artists).
...
The [artist entry description](/docs/artists/artist-entry-editing#Artist-description) truncated to the first ~~400 characters. If longer than this, a "Show full description" -button is provided.

The English translation (if available) is shown by default, regardless of user language preferences.

#### Release date

[Release date](/docs/artists/artist-entry-editing#Voicebank-release-date) of the voicebank.

#### Illustrated by

[Illustrators](/docs/artists/artist-entry-editing#Illustrator) of the voicebank.

#### Voice provider

[Voice providers](/docs/artists/artist-entry-editing#Voice-provider) of the voicebank.

#### Managed by

[Managers](/docs/artists/artist-entry-editing#Manager) of the voicebank.

#### Character designer

[Character designers](/docs/artists/artist-entry-editing#Character-designer) of the voicebank.

#### Type

[Artist type](/docs/artists/artist-entry-editing#Artist-type)

#### Language(s)

[Supported voicebank language(s)](/docs/artists/artist-entry-editing#Languages)
...
[Base voicebank](/docs/artists/artist-entry-editing#Base-voicebank) of the voicebank.

#### VocaDB account

If the [artist entry is verified](/docs/starting/artist-verification), the corresponding user profile link is displayed here.
...
[Groups and labels](/docs/artists/artist-entry-editing#Groups-and-circles) that the artist is a member of.
...
Entry creation date. Corresponds to the last row in [the entry history -table](/docs/artists/artist-entry-editing#View-modifications), except with the most earliest entries.
...
[Additional artist pictures](/docs/artists/artist-entry-editing#tab-Additional-pics) are displayed on this tab.
