...
Artist entry is a duplicate and should be [merged](/docs/guidelines/merging-entries). A link to the duplicate artist entry is required along with proof.

#### 3. Inappropriate content

For artists entries that [do not belong to VocaDB](/docs/guidelines/content-policy#Artists).
