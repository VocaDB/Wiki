...
- Make a post on your official social media (Twitter/X, YouTube, etc.) saying you want your account verified on VocaDB. The post should link to your VocaDB user account (https://vocadb.net/Profile/), not your artist page (https://vocadb.net/Ar/).
...
- Another way is to send a message to a site moderator. [Other contacting options](/docs/contact).
