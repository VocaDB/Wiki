...
Always credit the **earliest** "Gakupo Power" bank (V3 instead of V4) along with the ["unspecified voicebank engine"](https://vocadb.net/T/9027/unspecified-voicebank-engine) -tag.
