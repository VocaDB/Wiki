...
parent: Artists
tags:
  ["wikipage", "artists", "editing", "guidelines", "documentation", "vocadb"]
---
...
- Picture of the artist, but **only** if publicly available on artist's website/online profile (Twitter/X, Facebook etc.). \* Photo taken by a fan or posted on artist's private profile should not be used,
