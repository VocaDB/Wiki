...
3. Make sure that the artist is not listed [here](/docs/guidelines/forbidden-artists).
...
Make sure that the (main) artist of the album is not listed [here](/docs/guidelines/forbidden-artists/).
...
Make sure that the (main) artist of the song is not listed [here](/docs/guidelines/forbidden-artists/).
...
[Event entries](/docs/guidelines/events) have no creation requirements, as long as they apply to at least one album/song.
...
More on the wiki page for [tags](/docs/guidelines/tags).