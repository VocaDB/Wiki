...
This page explains what kind of entries are accepted for each entry type.
...
* [Associated artists](https://wiki.vocadb.net/wiki/83/artist-entry-editing#Associated-artists) for voicebanks.

2. Artists that are **not voice-synth-related**, should not be added to the database. This is important to keep in mind when editing [cover unifier -songs](https://vocadb.net/T/6751).
...
3. Make sure that the artist is not listed [here](https://wiki.vocadb.net/wiki/26/).

### Voicebanks

Unreleased voicebanks with no demo songs **should not be added**.

Artist entries for unofficial voicebanks, generated from existing singing voices **without constent** are not allowed. Song credits should be added with "custom artist" -feature along with the [unofficial voicebank/Jinriki -tag](https://vocadb.net/T/7095/unofficial-voicebank).

Fan-made derivatives such as pitchbends and genderbents, and especially for simple character designs such as [Hagane Miku](http://vocadb.net/Ar/1787), **should not be added as artist entries**. Corresponding tags should be used instead: https://vocadb.net/T/92/derivative.

 Official derivatives made or commissioned by the original creator of the voicebank, whether that's for Vocaloid or UTAU, are obviously **allowed**.

## Albums

Make sure that the (main) artist of the album is not listed [here](https://wiki.vocadb.net/wiki/26/).
...
Make sure that the (main) artist of the song is not listed [here](https://wiki.vocadb.net/wiki/26/).
...
[Event entries](https://wiki.vocadb.net/wiki/36/events) have no creation requirements, as long as they apply to at least one album/song.

## Tags

Empty tag entries (without anything but the name) are not accepted. 

Tag category & description are required.

More on the wiki page for [tags](https://wiki.vocadb.net/wiki/28/tags).