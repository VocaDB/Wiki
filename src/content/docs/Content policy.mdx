...
* [Associated artists](/docs/artist-entry-editing#Associated-artists) for voicebanks.
...
#### 3. Make sure that the artist is not listed [here](/docs/forbidden-artists).
...
Additionally, the album must have had a physical (i.e. CD) or digital release (i.e. Bandcamp, Spotify, etc.) at some point in time. Sometimes artists "publish" their song collections as a playlist which is insufficient for an album entry.
...
Make sure that the (main) artist of the song is not listed [here](/docs/forbidden-artists/).
...
[Event entries](/docs/events) must be related to vocal synths, but otherwise have no creation requirements
...
More on the wiki page for [tags](/docs/tags).