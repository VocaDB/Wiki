...
Content removal request **must always be verified** in some way. Having a [verified artist account on VocaDB](/docs/artist/artist-verification) is one way of doing it.
...
Make sure to [verify your artist entry](/docs/artist/artist-verification) first!
