...
Content removal requests on _notable_ entries **will be rejected in most cases**. The specific criteria are documented below.
...
#### Other artist types (illustrator, other vocalist, lyricist, instrumentalist, other invidual)

For these artist types, the artist entry can be deleted and replaced with custom artist credits, if there are less than 5 entries where they participate.
