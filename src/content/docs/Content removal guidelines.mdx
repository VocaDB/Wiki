...
Note that [verified artists](/docs/artists/artist-verification) can:
- Protect their artist entry, preventing edits from [regular users](/docs/documentation/user-groups#regular-user).
...
- Having a [verified artist account on VocaDB](/docs/artists/artist-verification) is one way of doing it. 
