...
Content removal request **must always be verified** in some way. Having a [verified artist account on VocaDB](/docs/starting/artist-verification) is one way of doing it.

Most of the time, the original media should be **deleted** first to avoid someone adding it again on VocaDB.

If artist wants to create music without a VocaDB presence, they can request their name in the [forbidden artists -page](/docs/guidelines/forbidden-artists/forbidden-artists). This is one way of making sure that users do not add their content to the site.
...
Make sure to [verify your artist entry](/docs/starting/artist-verification) first!
