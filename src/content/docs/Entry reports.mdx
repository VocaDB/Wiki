...
Instead of reporting an old entry for a [specific rule violation](/docs/pinned/rule-reference), it's usually more *productive* to locate or generate a corresponding entry list instead, and work through that collaboratively.
