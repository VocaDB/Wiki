...
parent: Pinned
tags: ["wikipage", "guidelines", "moderation", "entry reports", "user", "documentation", "vocadb"]
---
...
Instead of reporting an old entry for a [specific rule violation](/rules), it's usually more *productive* to locate or generate a corresponding entry list instead, and work through that collaboratively.
...
Entries made by [MikuMod](https://vocadb.net/Profile/MikuMod) can be ignored (unless they're addressed to you) as these are automatically managed.
