...
Always include **relevant evidence** in your report when appropriate.
...
When reporting mistakes, providing the **relevant context** by linking to the wiki is helpful to everyone, especially so that the editor can learn from their mistake. 
...
Note that artist entries **should not be automatically merged**, even if it can be proven that they are the [same person/individual](/docs/other-guidelines/merging-entries#splitting-artist-entries).
