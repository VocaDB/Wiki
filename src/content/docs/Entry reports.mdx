...
Instead of reporting an old entry for a [specific rule violation](/docs/rule-reference), it's usually more *productive* to locate or generate a corresponding entry list instead, and work through that collaboratively.
...
**Do not use entry reports for questions or discussions**. Use the entry comments, [discussions](https://vocadb.net/discussion), or [Discord](https://discord.com/invite/3bwXQNXKCz) for these purposes. 
