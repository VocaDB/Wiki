...
tags: ["wikipage", "artists", "songs", "albums", "editing", "guidelines", "moderation", "merging entries", "splitting entries", "documentation", "vocadb"]
---
...
Assuming you have the necessary permissions, the merge option appears on the entry edit page. 

<RuleEmbed ruleId={28} fields={["id"]}/>
