...
Because undoing a merge can be a great deal of work, it is restricted to trusted users+ only. If you notice a duplicate entry but can't perform the merge yourself, leavy an entry report (including the other duplicate).
