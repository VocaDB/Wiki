...
parent: Pinned
tags: ["editing", "guidelines", "user", "documentation", "vocadb"]
---
...
- There is no need to make an entry report to delete an article you created yourself. You can delete it by editing it and pressing "Delete" at the top of the page.
