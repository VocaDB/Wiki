...
tags: ["editing", "guidelines", "romanization", "translation", "transcription", "names", "lyrics", "languages", "documentation", "vocadb"]
---
...
First of all, thank you for your help! Most of the above guidelines need not apply for lyric romanizations, but we request that you do follow the guideline of not using macrons for long vowels. Otherwise, the style is up to your discretion.
