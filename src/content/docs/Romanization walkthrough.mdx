...
This guide is an in-depth supplement to the [romanization guideline](http://wiki.vocadb.net/wiki/1/romanization-guidelines) for romanizing Japanese song and album titles. This guide will not focus on Artist names, as names have even more rules and exceptions.
...
![Rikai-sama](public/images/romanization-walkthrough/Rikai001.png)\\
...
Please join VocaDB's IRC channel at #vocadb on irc.rizon.net or our Discord server and let us know of the error.