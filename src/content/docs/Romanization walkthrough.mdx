...
This guide is an in-depth supplement to the [romanization guideline](/docs/guidelines/romanization-guidelines) for romanizing Japanese song and album titles. This guide will not focus on Artist names, as names have even more rules and exceptions.
