...
Rule documented at [entry-names-and-aliases](/docs/guidelines/entry-names-and-aliases)
...
FAQ also updated regarding this: /docs/guidelines/vocadb-editing-faq#If-a-Vocaloid-song-was-released-simultaneously-with-a-human-vocals-version

### Single albums

Single albums are no longer discouraged.

FAQ updated: /docs/guidelines/vocadb-editing-faq#Should-I-create-an-album-entry-for-a-song
