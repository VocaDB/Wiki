...
## Rule: No out-of-scope song entries
...
## Rule: No song entries by forbidden artists
...
## Rule: Entry tree structure

Entry tree structure should be immutable and sorted by publish date:

- 1) Order the relevant entries by publish date.
