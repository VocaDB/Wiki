...
### Rule: Song content policy: No AI generated songs
...
### Rule: External links: Link categories
...
## Rule: No new non-English title translations

New non-English title translations should not be added.

Unless they're used elsewhere (for better searchability) or they're related to the original name ('Матрёшка' for Matryoshka).
...
- Relevant validation errors: `UnnecessaryPName`

## Rule: Separate artist personas

Respect artists' wishes to keep artist personas separate.

Elaborated on [this page](/docs/merging-entries)
...
- The main picture should be chosen based on [the relevant guidelines](/docs/choosing-the-main-picture-for-artist-entries).
...
All tags should have at least one valid [purpose](/docs/tags#tag-purposes).
