...
[Deleting song entries](/docs/guidelines/content-removal-guidelines) | [Merging song entries](/docs/guidelines/merging-entries)
...
- [Entry names and aliases](/docs/guidelines/entry-names-and-aliases)
...
If the original is a voice synth song, add the original song to the database and link the original to the derived version using the [Original version -field](/docs/songs/song-entry-editing#Original-version)
...
- [External links](/docs/guidelines/external-links)
...
Vocaloids, UTAUs and other singing synthesizer voicebanks are added as artists as well: [Choosing the correct voicebank credit](/docs/guidelines/choosing-the-correct-voicebank-credit)

Original artist should not be added to cover/remix song entries, with some exceptions:
...
** If the out-of-scope song entry exists, then original artist should not be added to the derived entry.
...
Songs may contain any number of embedded media files (Promotional Videos = PVs) on Niconico (NND), YouTube, Bilibili, Vimeo, or audio streams on Piapro or SoundCloud. The supported media services are fully listed [here](/docs/documentation/media-video-services-supported-by-vocadb).
...
[Romanization guidelines](/docs/guidelines/romanization-guidelines) do not apply to lyrics, but pure machine-translations are not allowed.
