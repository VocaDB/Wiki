...
The edit page also includes buttons for [deleting](/docs/other-guidelines/content-removal-guidelines) and [merging](/docs/other-guidelines/merging-entries) song entries.

The edit page is split into 4 different tabs:

1) [Basic info](/docs/songs/song-entry-editing#tab-1-basic-info)
2) [Artists](/docs/songs/song-entry-editing#tab-2-artists)
3) [Media](/docs/songs/song-entry-editing#tab-3-media)
4) [Lyrics](/docs/songs/song-entry-editing#tab-4-lyrics)
...
General instructions for entry names (= titles) and aliases are documented [here](/docs/other-guidelines/entry-names-and-aliases).
...
[Verified artists](/docs/artists/artist-verification) can submit subjective comments using the [artist's personal description](/docs/songs/song-entry-page#artists-personal-description).
...
Links to lyrics should be added to the [Lyrics tab](/docs/songs/song-entry-editing#tab-4-lyrics) instead.
...
- More on [External links](/docs/other-guidelines/external-links)
...
If you would like to make romanizations of lyrics for VocaDB, please read the [Romanization guidelines](/docs/other-guidelines/romanization-guidelines#what-if-i-want-to-romanize-song-lyrics-for-vocadb). 
