...
Trusted users are able to create public song lists called pools. Pools can be used for largely the same purpose as tags, grouping songs together based on some common theme. There are a few differences between tags and song lists.

* Pools are listed on the featured song lists page.
...
Next: [Events](/docs/secondary-entry-types/events).