...
- Ideally tags in the same category share the same tag usage rules.

- Ideally tags belong to only one category.
...
Avoid creating tags for C and D if the number of relevant song entries is less than 5.
