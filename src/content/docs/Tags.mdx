...
Tag description should describe the tag concept in clear English language. For normal tags, skip generic usage instructions such "tag for albums/artist/songs...". Use "Valid for" -restrictions instead.
