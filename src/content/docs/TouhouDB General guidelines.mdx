...
- If you are romanizing a title, please check the [Romanization Guidelines](https://wiki.vocadb.net/docs/romanization-guidelines) and [Romanization Walkthrough](https://wiki.vocadb.net/docs/romanization-walkthrough) for examples.
...
See [TouhouDB - Artists](https://wiki.vocadb.net/docs/touhoudb-artists).

## Albums

See [TouhouDB - Albums](https://wiki.vocadb.net/docs/touhoudb-albums).

## Songs

See [TouhouDB - Songs](https://wiki.vocadb.net/docs/songs).
