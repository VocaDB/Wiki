...
TouhouDB is built on the same infrastructure as [VocaDB](https://vocadb.net/), and makes use of the same key features, such as integration with streaming platforms, open source code, an accessible API, and more. A full list of features can be found [here](https://wiki.vocadb.net/docs/footer/vocadb-what-is-it-for).
