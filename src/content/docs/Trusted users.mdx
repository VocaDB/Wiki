...
* Before [merging entries](/docs/guidelines/merging-entries), keep in mind that undoing a merge, especially merging artist entries, can be a lot of work, so please make sure the entries really need to be merged.
...
[Also see the editing FAQ](VocaDB editing FAQ) and [User groups](User groups).
