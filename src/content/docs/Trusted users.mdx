...
* Before [merging entries](https://wiki.vocadb.net/wiki/46/merging-entries), keep in mind that undoing a merge, especially merging artist entries, can be a lot of work, so please make sure the entries really need to be merged.
