...
* [Deleting any entry ](https://wiki.vocadb.net/wiki/54/content-removal-guidelines) (not just the ones they created)
* [Merging an entry](https://wiki.vocadb.net/wiki/46/merging-entries)
* Creating and editing "featured songlists"
* Managing [entry reports](https://wiki.vocadb.net/wiki/58/entry-reports)
...
Also see [moderation guidelines](http://wiki.vocadb.net/wiki/53).
...
For a staff list, visit [this page](https://wiki.vocadb.net/wiki/44/staff-roles).
...
* [Artist verification](https://wiki.vocadb.net/wiki/40/artist-verification)
