...
* [Deleting any entry ](/docs/guidelines/content-removal-guidelines) (not just the ones they created)
* [Merging an entry](/docs/guidelines/merging-entries)
* Creating and editing "featured songlists"
* Managing [entry reports](/docs/guidelines/entry-reports)
...
For a staff list, visit [this page](/docs/documentation/staff-roles).
