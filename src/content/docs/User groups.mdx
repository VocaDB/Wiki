...
* Generally, trusted users should only limit users in cases of spam or vandalism. Besides those cases, limiting is handled by mods and above.
...
* [Moderating comments](https://wiki.vocadb.net/docs/pinned/discussion-rules)
...
Isers that have financially contributed to VocaDB, through [Patreon](https://www.patreon.com/vocadb) for example.