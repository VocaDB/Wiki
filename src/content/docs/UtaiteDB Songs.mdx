...
UtaiteDB uses a slightly modified version of the song types from VocaDB. Please see the wiki entry page for [song types](/docs/song-entry-editing#song-type).
