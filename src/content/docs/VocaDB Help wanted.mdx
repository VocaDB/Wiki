...
-> [Guide: Translating VocaDB](https://wiki.vocadb.net/wiki/10/translating-vocadb)
...
-> [Guide: VocaDB feature requests](https://wiki.vocadb.net/wiki/51/vocadb-feature-requests)
