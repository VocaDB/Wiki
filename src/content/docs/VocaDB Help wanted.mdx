...
We currently have a dev who takes care of most things but anyone who helps with fixing bugs and implementing or updating features is very appreciated.
...
### Fixes to the mobile layout

Currently some pages don't fit the phone screen very well, for example: The highlighted PVs list on the front page. If someone could do some testing and CSS tuning, we can import the fixes to the website.
