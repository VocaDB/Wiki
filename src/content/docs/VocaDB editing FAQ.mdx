...
### Are songs with //human vocals// / //instrumental only// allowed on VocaDB?
...
More on [Content policy/Songs](https://wiki.vocadb.net/wiki/59/content-policy#Songs).
...
More on [Choosing the correct voicebank credit](https://wiki.vocadb.net/wiki/79/choosing-the-correct-voicebank-credit) -page.
...
# Voicebanks have separate brand names / boxart
