...
- Post a tweet saying you want your account verified on VocaDB. To do
  this, \_\_use your artist Twitter account\_\_, to create a Tweet
  \_\_linking to your VocaDB **user** account\_\_ (instead of your
  artist page).

For example: ![](/images/verification.PNG)

- Another way is to send a private message (on
  [VocaDB](https://vocadb.net/) itself,
  [Discord](https://discord.com/invite/3bwXQNXKCz),
  [Twitter](https://twitter.com/VocaDB) or as an E-Mail:
  support@vocadb.net). For example, on
  [Twitter](https://twitter.com/VocaDB) you can send direct message
  (DM) to [\@vocadb](https://twitter.com/vocadb).
...
- Japanese:
  [アーティストの本人確認](https://wiki.vocadb.net/wiki/73/%e3%82%a2%e3%83%bc%e3%83%86%e3%82%a3%e3%82%b9%e3%83%88%e3%81%ae%e6%9c%ac%e4%ba%ba%e7%a2%ba%e8%aa%8d)

---

[Help & Contact](https://vocadb.net/Help) \|
[Terms of service](https://wiki.vocadb.net/wiki/52/terms-of-service) \|
[Privacy & cookie policy](https://wiki.vocadb.net/wiki/50/privacy-and-cookie-policy)
\| [License](https://wiki.vocadb.net/wiki/29/license) \|
[About VocaDB](https://wiki.vocadb.net/wiki/13/vocadb-what-is-it-for) \|
[About staff](https://wiki.vocadb.net/wiki/44/staff-roles)
