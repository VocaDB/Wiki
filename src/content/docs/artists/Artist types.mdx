...
parent: Artists
tags: ["artists", "draft", "editing", "guidelines", "documentation", "vocadb"]
---

Artist type specifies the _most common_ role that the artist participates in. Additional roles should be specified with [tags](https://vocadb.net/T/7372/artists).
