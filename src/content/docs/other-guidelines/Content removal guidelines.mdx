...
Content removal requests **must always be verified** in some way. Having a [verified artist account on VocaDB](/docs/artists/artist-verification) is one way of doing it. 
